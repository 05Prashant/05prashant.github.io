---
title: "The Value of a Photograph"
...
Slowly parts of the software development lifecycle are getting automated or simplified. Website builders like [Webflow](https://webflow.com/) let you build something without knowing any code; we have games like [Dreams](https://store.playstation.com/en-gb/product/EP9000-CUSA04301_00-DREAMS0000000000) and [Pulp for Playdate](https://play.date/pulp/) that make building games more accessible. We have tools like [Replit](https://replit.com/), [Heroku](https://www.heroku.com/developers) that make deploying your code to end users easier. And lastly, the stimulus for this article, in the last 6 months we have seen some interesting code generators like [Github's Copilot](https://github.com/features/preview/copilot-x) and [OpenAI's Chat GPT](https://openai.com/product/gpt-4). It seems like the best minds are already thinking of leveraging this tech to make creating software easier. They are working on making the "How" of software easier to answer.
