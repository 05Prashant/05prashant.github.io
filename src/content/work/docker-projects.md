...
- **A good product is a lagging metric of a healthy team.** In the early days, I spent time building relationships and creating a space for healthy design critiques. When we were under pressure to deliver, or things went wrong, we trusted each other to make the right decision. Each member of the team cared deeply about the experience, because they were involved from the start.
